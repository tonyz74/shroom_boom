...
cp target/x86_64-apple-darwin/release/shroom_boom dist/$PROJECT.app/Contents/MacOS
cp dist/Info.plist dist/$PROJECT.app/Contents
cp assets/icon/Icon.icns dist/$PROJECT.app/Contents/Resources